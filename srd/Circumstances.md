...
date updated: 2022-01-06 14:56
---

# Circumstances

Circumstances are the parts of your character that make them _yours_. They are mostly just a collection of words and phrases, but they encapsulate a lot of personal meaning. They are the first thing you see on your [[Character Resources|character sheet]], and they should always help to guide you back into character while roleplaying, [[Agenda|to find your agenda]], or to remind you of who you're playing if there's been a long break between sessions.

## Types of Circumstance

There are eight spaces to fill in with descriptive information about your character:

| Group                      | Subgroup                   |
| -------------------------- | -------------------------- |
| **[[#Name]]**              | **[[#Aliases or Titles]]** |
| **[[#Archetypes]]**        | _Optional:_ **[[Wealth]]** |
| **[[#Background Traits]]** | **[[Size]]**              |
| **[[#Foreground Traits]]** | **[[Age]]**               |

### Name

This is simply your most preferred or most publicly known identifying proper noun (and your respective pronouns).

**In other words:** _This is just what everyone calls you_.

Choose a name that means something symbolic to you, or which means something in your culture's native language, or randomly generate one.
...
[[Character Assembly#2 Archetypes|Archetypes]] are a type of 'loadout' which you choose from a few lists during [[Character Assembly|character assembly]]. They define your character's species or ancestry, their cultural or geographic origin, and their most recent profession, or what they've spent most of their life training to do best.

This choice grants them most of their starting [[Jobs|job levels]], some [[Specialties|specialties]], [[Assets and Gear|assets or gear]], and sometimes a unique [[Gambits|gambit]], [[Conditions|condition]], or some [[Spellcasting|spells]] — as well as their starting [[Wealth]].

Taking an archetype doesn't exclude you from taking other jobs or specialties later on. Think of them like templates, or scaffolding, that's done most of the ground work but leaves some blanks for you to fill in.

> ### Eg.
> 
> You need to list your choice of archetypes on your [[Character Resources|character sheet]] for bookkeeping purposes, but you can personalize them quite a bit.
> - Instead of just flatly listing *"Human (species), Imperial (culture), Sentinel (profession)"* you could write *"Ōuchi Clan Samurai"*, if you were playing in a historical setting (ie. In the Japanese [Segoku Jidai](https://en.wikipedia.org/wiki/Sengoku_period)).
> - Instead of *"Elf, Pillar, Duelist"* you could write *"Elven Escorte de la Philosophie de L'étude du Couteau"*, whatever that means…?
> 
> In many ways, the way you write your archetypes can strongly reflect your original [[Character Assembly#1 Concept Concept Concept|character concept]] or add flavor to the world you're playing in.
...
> - Religion, heritage, or ethnic roots
...
> - Common features (similarities to the norm)
...
You may notice some _repeated entries_ between the suggested foreground and background traits, and that's because your traits are personal to _you_.
...
In truth, there is no mechanical difference between the two sets of traits — just their narrative placement in the landscape of your self-identity. Ultimately, these traits function mainly as _guideposts to help you recenter your character_, or to help you [[Agenda|find your agenda]]; but they can also earn you [[Lots]].
...
> - Divergent features (differences from the norm)
...
###### Cosmetic & Cultural Expressions

Your character comes from a culture that undoubtedly looks different from the many other peoples across the world, and those people will think different things about what they consider beautiful or ugly. Some characters have also traveled to other nations, planets, or dimensions, too, and changed themselves to try to fit in. Some reject their heritage entirely, and try to define themselves on their own terms.

What does your culture value that differs from your own values? How do you make yourself appear attractive or desirable to people of your own culture, or to others? What parts of your self do you flaunt? Or do you try to avoid attention, and how, if so? How do you look despite how you want to be perceived? What parts of your self cannot (or should not) be hidden?

Answers to these questions can all serve as background or foregound traits.
...
> ### Eg.
>
> They can be as broad and wide-reaching as "Undead" — which would imply, for example, that undead creatures are _sapient and playable_ in your world — or as narrow and specific as "West-islander tattoos (spiral patterns)" or "Missing tooth (upper-left canine)".
...
There's technically no limit on how many circumstances a character can have, but you'll more than likely run out of space on the [[Character Resources|character sheet]] before you run out of ideas. This is a good _natural limit_, as the constraint forces you to be reserved about your choices.
