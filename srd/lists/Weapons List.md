...
**They grant no inherent dice from materials or weight** — except for certain moves — **and instead derive their main bonus dice from the production quality:** [[Common-Quality|Common]] (CQ), [[Excellent-Quality|Excellent]] (EQ), or [[Superior-Quality|Superior]] (SQ).

❓ This quality system assumes that you're using period-appropriate weapons and armor against one another in a battle. If someone is somehow using modern guns against iron age armor, for example, then your [[Facilitator|FC]] may grant a few bonus dice to the attacker to compensate.

---

###### Alternative Weapons

Some of the weapons in this list have alternatives — usually #great variants — which are listed in a blue **`monospace font`** and have extra tags and a higher cost also listed in that font.
...
| :--------------------------------------- | ------------------- | ------------- | -------------------- | ----------------------------- | ------: |
| **Axe / Chopper, `Machete`**             | #brawler `#warrior` | #medium       | #rending             | —                             | 3¢ `4¢` |
...
❓ All lower quality items (above) may be bought at this higher quality too, but you'll have to work out their prices by yourself.
...
| **Cudgel Staff**        | #martialist | #long #super-heavy | #bashing   | —                    | 15¢  |
...
| **Dire Maul**            | #any-melee          | #short #super-heavy  | #crushing          | #spread                     | 21¢  |
| **Sublime Glaive**       | #any-melee          | #long #super-heavy   | #rending           | #formation #cavalry #spread | 24¢  |
| **Tract Reaver**         | #any-melee          | #medium #great       | #rending           | #hand-guard #spread         | 24¢  |

#### SQ Firearms

| Weapon (Alt.)                |         | Weight                 | Damage    | Additional                            | ₡ost      |
| :--------------------------- | ------- | ---------------------- | --------- | ------------------------------------- | --------- |
| **Flame Thrower**            | #gunner | #short #heavy          | #burning  | #firearm #flexible #spread            | 21¢       |
| **Hand Mortar**              | #gunner | #short #heavy          | #rending  | #artillery #firearm #one-shot #spread | 27¢       |
| **Heavy Machine Gun**        | #gunner | #long #super-heavy     | #rending  | #artillery #firearm #auto             | 24¢       |
...
| **Sniper Rifle**             | #gunner | #long #super-heavy     | #piercing | #firearm #reload #scope               | 24¢       |
| **Shotgun, `Coach Gun`**     | #gunner | #short #heavy `#great` | #bashing  | #firearm #two-shot `#reload`          | 21¢ `27¢` |

❗ Some tags, like #scope and #bayonet, may also be removed for a cheaper item.
