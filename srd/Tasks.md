...
date updated: 2021-12-16 21:07
---

## Tasks

**Tasks are more complicated than [[Checks]].** They are a measure of your training and expertise, and can be used to achieve multiple things at a time, or many things sequentially.

![[Task Summary]]

### 1. Set-up

This is the discussion phase, where you must [[Agenda|state your agenda]] and describe how and why you want to achieve it in game. Then **talk with your your [[Peers]]** about how that agenda translates into 'objectives' and _what the consequences of your actions will be_, as well as which job to use and how many dice you'll be rolling, and the difficulty of the Task.

#### Discuss Objectives and Consequences
...
> ### Ie.
>
> _Whenever you attempt to impose your agenda, the world reacts._ Though those reactions aren't entirely in your control — and may not even be _known_ to your character — you deserve to know what they're likely to be, so you can make an informed decision about how to proceed.

❗ There is always room to adjust the consequences before you roll dice: If you shift your objective slightly, or change your description to use a different job, the consequences may alter in kind.

#### Gather your Job's Level in Dice + Bonuses
...
>
> All four of these things can be accomplished with a single roll of the [[Thief]] job, _for example_. Breaking it up into multiple rolls each with fewer factors would be definitely be easier — but it would also take more time, and the world may react to your actions in the interim.
...
#### KISS your dice to _Reroll_ them!
...
#### Helpers may KISS dice for you!

![[Helping]]

❗ **You must accept the results once you have KISSed and rolled all the dice you wanted to**, even if they're no better (or worse) than the initial roll. _There is only one round of KISSing per roll_.
...
- **If you have fewer successes than the number of factors, then you fail the Task and _none_ of your objectives are properly fulfilled.**

Typically, once you've rolled for a Task, either you or your FC can _describe what the outcome looks like_.
...
**If you got more successes than the threshold**, the difference is called your 'margin of success'. This may, in some instances, be used to achieve an additional objective, or to attain an exceptional success; but only so long as it was preestablished before the roll. Otherwise, margin of success just means you can describe your success with aplomb.

Although, **if you manage to roll _twice the difficulty_ in successes** then the [[Facilitator|FC]] _should usually reward you with something extra_, even if it wasn't preestablished.

Similarly, **if you failed by a small margin**, then you may describe which factors were overcome and which ones ultimately foiled you. This is mostly for narrative effect though — _the main consequences of failure will still be applied._

#### Gaining Experience from a Roll

When you perform a Task, _regardless of success or failure_, **you will gain a point of _[[Earning Experience|experience]]_ in the job you just used**. Filling in the next _'exp'_ diamond on your character sheet under that job's name (ie.  ◇ → ◆).

If you failed the roll then **add an additional point of exp** to represent _learning from your mistakes_.
